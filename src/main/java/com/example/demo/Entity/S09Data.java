...
public class S09Data {
    ...
    private Double weldGas;//累计焊接气体消耗
    private Double weldWire;//累计焊丝消耗
    private Long startUpTime;//开机时间
    private Long processingTime;//加工时间
    private List<String> preStatus;//过去20次变化
    private List<String> hourlyGasData;//每小时焊接气体数据
    private List<String> hourlyWireData;//每小时焊丝数据

    public List<String> getHourlyGasData() {
        return hourlyGasData;
    }

    public void setHourlyGasData(List<String> hourlyGasData) {
        this.hourlyGasData = hourlyGasData;
    }

    public List<String> getHourlyWireData() {
        return hourlyWireData;
    }

    public void setHourlyWireData(List<String> hourlyWireData) {
        this.hourlyWireData = hourlyWireData;
    }
    ...
    public Double getWeldGas() {
        return weldGas;
    }

    public void setWeldGas(Double weldGas) {
